...
<html>
	...
	<body onload="trackTime(); hideLoaders();">
		...
		<div id="wrapper">
			<p id="top_bar" style="border-bottom: 1px solid black; padding-bottom:5px;"><?php echo "Logged in as <b>" . $user->username . "</b>"; ?>
			(<a href="../logout">Log Out</a>)
			| <a href="..">Home</a> | <a href="/chat">Chat Lobby</a> | <a href="messenger">Messenger</a>
