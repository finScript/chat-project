...
<html>
	...
	<body onload="trackTime(); inpSendText(1); hideLoaders(); hideFileSelect(); setTimeout('handleMessages();', 500);">
		...
		<div id="wrapper">
			...
			<a id="btn_toggle_events" href="" onclick="event.preventDefault();toggleEvents();" style="position: absolute; right: 25%;">Show Events</a>
			...
			<div id="messenger">
				...
				<div id="send_area">
					...
					<input type="text" id="txt_message" autocomplete="off" onfocus="inpSendText(0);" onfocusout="inpSendText(1);" onkeyup="checkEnterSend(event);" />
					<a href="" onclick="event.preventDefault(); selectFile();"><img src="../img/file_black.png" width="25" height="25" style="vertical-align: -8px" title="Send file" /></a>
					<button onclick="sendMessage()" type="button" id="btn_send">Send</button>
