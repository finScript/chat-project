...
<html>
	...
	<head>
		...
		<meta name="viewport" content="" id="view_meta" />
	...
	<body onload="trackTime(); inpSendText(1); hideLoaders(); hideFileSelect(); setTimeout('handleMessages();', 500); scale();">
		...
		<p id="top_bar">Logged in as <b><?php echo $user->username; ?></b> (<a href='../../logout'>Log out</a>)
			...
			<a href="..">Lobby</a>
			|
			<img src="../../img/calendar.png" width="20" height="20" style="vertical-align: -4px;" />&nbsp;--><span id="cur_time" style="display: none;"></span>
